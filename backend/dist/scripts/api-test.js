...
async function testRegister() {
    try {
        ...
        const response = await axios_1.default.post(`${BASE_URL}/auth/register`, {
            name: "Test User",
...
async function testCreateSession(token) {
    try {
        ...
        const response = await axios_1.default.post(`${BASE_URL}/whatsapp/session`, {}, {
            headers: {
...
async function testCheckStatus(token) {
    try {
        if (!token) {
        ...
        const response = await axios_1.default.get(`${BASE_URL}/whatsapp/status`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        });
